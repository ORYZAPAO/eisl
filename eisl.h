...
extern int ed_name;
extern char ed_data[2000][160];
extern char ed_copy[500][160];
...
typedef void (*p_f5)(int, int);
typedef void (*p_f6)(int, int);
typedef void (*p_f7)(int, int);
typedef void (*p_f8)(int, int);
